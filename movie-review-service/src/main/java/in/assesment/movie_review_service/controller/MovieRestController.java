...
public class MovieRestController {
	...
	public ResponseEntity<ResponseDto<List<Movie>>> getAllMovieById(@AuthenticationPrincipal final UserInfo userInfo){
		try {
			ResponseDto<List<Movie>> response = movieService.getAllMoviesByUserId(userInfo.getId());
